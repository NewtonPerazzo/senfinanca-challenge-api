...
def-env activate-virtualenv [] {
    ...
    let virtual-env = '/home/newton/Área de Trabalho/senfinanca-challenge-api/.venv'
    let bin = 'bin'
    let path-sep = ':'
...
alias deactivate = source '/home/newton/Área de Trabalho/senfinanca-challenge-api/.venv/bin/deactivate.nu'
